    ...
    <div class="container">
      ...
      <div class="movie-list">
        <a href="#" class="movie-link">
          <img
            src="https://1.bp.blogspot.com/-Dr-Up74eCmI/YY7d1mj6bFI/AAAAAAAAPf8/vdxywrv4cHcvmbnSrNLCh-KspcktyhckwCLcBGAsYHQ/s1500/Untitled.jpeg"
            alt=""
          />
  ...
  <section class="trend-movie">
    <div class="container">
      ...
      <div class="movie-list">
        <a href="#" class="movie-link">
          <img
            src="https://tr.web.img4.acsta.net/pictures/19/02/15/15/25/5530751.jpg"
            alt=""
          />
          <span class="head-title">Actions Film Top 10</span>
        </a>
